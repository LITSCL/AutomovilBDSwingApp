		...
		addInternalFrameListener(new InternalFrameAdapter() {
			...
			public void internalFrameOpened(InternalFrameEvent arg0) {
				...
				if (automovilesIngresados.isEmpty() == true) { //Aca se revisa si hay automoviles en la lista, de no ser así se ejecuta el código.
					JOptionPane.showMessageDialog(null, "No hay automoviles registrados en el sistema"); //El primer parámetro corresponde a la ubicacón del mensaje y el segundo parámetro corresponde al texto del mensaje.
